...
const AIChat = ({ inDrawer = false }: AIChatProps) => {
  ...
  const sendMessage = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      } else if (userQuery.includes("doctor") || userQuery.includes("therapist") || userQuery.includes("specialist")) {
        botResponse = "Our team consists of certified physiotherapists with diverse specializations. Each doctor has years of experience in their respective fields. Would you like to know more about our specialists?";
      } else if (userQuery.includes("benefit") || userQuery.includes("advantage") || userQuery.includes("why")) {
        botResponse = "Vitality Physio offers many benefits including personalized treatment plans, state-of-the-art facilities, continued care beyond in-person sessions, and integration with telehealth. Our platform also makes managing patient records and scheduling easy for our practitioners.";
      }
  ...
  return (
    <div className={`flex flex-col ${inDrawer ? 'h-[65vh]' : 'h-[600px]'}`}>
