...
// Use the physiotherapy placeholder image (teleconsultation style)
...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-white/65 dark:bg-black/60 pointer-events-none" />
      <div className="relative z-10 w-full max-w-2xl mx-auto flex flex-col items-center text-center py-10 px-3 sm:py-14 sm:px-6 md:py-16 rounded-lg">
        <div className="flex items-center mb-2 bg-vitality-50 rounded-full py-1 px-4 w-fit mx-auto dark:bg-gray-800">
        ...
        <h1 className="text-2xl xs:text-4xl md:text-5xl font-bold mb-3 font-display text-vitality-700 leading-tight dark:text-white">
          Expert Physiotherapy Care Online & In-Clinic
        </h1>
        <p className="text-base sm:text-lg text-gray-700 mb-5 dark:text-gray-300">
          Book with certified physiotherapists – consult either online or visit in person. Quality care, just a click away!
        </p>
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="w-9 h-9 rounded-full bg-vitality-500 flex items-center justify-center text-white text-xs font-bold shadow">
            4.8
          </div>
