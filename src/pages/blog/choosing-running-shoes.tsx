  ...
  return (
    <PageLayout>
      <div className="container mx-auto py-16 px-4 max-w-2xl">
        ...
        <p className="mb-6">Find out what factors to consider when selecting running shoes that will support your unique gait and help prevent common injuries.</p>
        <p>Consider gait analysis, cushioning, fit, and always try before buying.</p>
      </div>
    </PageLayout>
  );
}
