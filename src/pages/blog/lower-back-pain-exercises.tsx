  ...
  return (
    <PageLayout>
      <div className="container mx-auto py-16 px-4 max-w-2xl">
        ...
        <p>1. Cat-Cow Stretch<br/>2. Child’s Pose<br/>3. Pelvic Tilts<br/>4. Knee-to-Chest Stretch<br/>5. Bird Dog<br/><br/>Always consult your physiotherapist before starting new exercises.</p>
      </div>
    </PageLayout>
  );
}
